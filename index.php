...
<body>
  <header class="header">
    <div class="head-body">
      <a href="#" class="header-icon">
        <img src="img/invoiceA2Z.png" alt="invoice A2Z Logo">
      </a>
      <div class="top-nav">
      ...
      <ul>
        <li class="menu-list" id="menuOne">
          ...
          <ul class="child-item d-none">
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuOne-1')">
                1.1 Personal Data
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuOne-2')">
                1.2 Usage Data
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuOne-3')">
        ...
        <li class="menu-list" id="menuFive">
          ...
          <ul class="child-item d-none">
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuFive-1')">
                5.1 Google Analytics
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuFive-2')">
                5.2 Firebase
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuFive-3')">
                5.3 Facebook Analytics
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuFive-4')">
                5.4 AppsFlyer
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuFive-5')">
                5.5 Advertising
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuFive-6')">
                5.6 AdMob by Google
              </a>
            </li>
          </ul>
        ...
        <li class="menu-list" id="menuSeven">
          ...
          <ul class="child-item d-none">
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuSeven-1')">
                7.1 Federal Trade Commission Regulations
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuSeven-2')">
                7.2 CCPA Privacy
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuSeven-3')">
                7.3 GDPR Legal Rights
              </a>
            </li>
            <li>
              <a href="javascript:void(0)" onclick="scrollToSection('menuSeven-4')">
                7.4 CCPA Legal Rights
              </a>
            </li>
          </ul>
        </li>
    ...
    <div class="main-content">
      ...
      <section id="menuOne-section">
        ...
        <div class="inner-section text-color">
          ...
          <div id="menuOne-3">
            ...
            <p>
              We collect, use, and share aggregated data like statistics or demographics, which are not classified as
              personal data under the law as they do not reveal your identity directly or indirectly. For instance, we
              might aggregate Usage Data to determine the percentage of users accessing a particular app feature. If we
              merge Aggregated Data with your information in a way that can identify you directly or indirectly, we
              consider the combined data as personal data and handle it according to our privacy policy.
            </p>
            <p>
              We use this information to provide features of the app and to improve and customize our service. The
              information may be uploaded to our servers and/or a third-party server, or it may be simply stored on your
              device.
            </p>
            <p>
      ...
      <section id="menuTwo-section">
        ...
        <ul class="text-color">
          ...
          <li>
            From service providers. For example, third-party vendors to monitor and analyse the use of our service, and
            third-party vendors to provide advertising on our service.
          </li>
        </ul>
      </section>
              ...
              <tr>
                ...
                <td data-label="Lawful Basis for Processing">
                  <ul>
                    <li>Performance of a contract with you.</li>
                    <li>Your consent.</li>
                    <li>Necessary for our legitimate interests (to keep our records updated and to study how customers use
                      our app).</li>
                  </ul>
                </td>
              </tr>
        ...
        <div class="inner-section text-color">
          ...
          <div id="menuFive-6">
            ...
            <p>
              ...
              when you use our partners' sites or app."
            </p>
            <p>
              Page: <a
                href="https://policies.google.com/technologies/partner-sites" class="text-link">https://policies.google.com/technologies/partner-sites</a>
        ...
        <div class="inner-section text-color">
          ...
          <div id="menuSeven-2">
            ...
            <p>
              ...
              with, or could reasonably be linked, directly or indirectly, with a particular user or device. The
              following is a list of categories of personal information that we may collect or may have collected from
            ...
            <p>
              ...
              extract a template or other identifier or identifying information, such as fingerprints, faceprints,
          ...
          <div id="menuSeven-3">
            ...
            <p>
              ...
              rights. You have the right under this Privacy Policy, and by law if you are within the EU, to:
            </p>
            <ul>
              <li>
            ...
            <p>
              We do not practice discrimination against any user (providing inferior services or charging extra for
              products) who exercises any of those rights mentioned above.
            </p>
          </div>
          <div id="menuSeven-4">
            <p class="bold-text-color">
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    If we sell your personal information or disclose your personal information for a business purpose,
  ...
  <section class="sub-footer">
    <div class="sub-footer-content">
      <h2>Manage your business like a pro</h2>
      <p>
